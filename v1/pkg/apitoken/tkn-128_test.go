...
func TestToken128_FromString(t *testing.T) {
	Convey("Token128.FromString", t, func() {
		foo := apitoken.Token128{}

		So(foo.FromString("01050a3264ff030d1738126345080f09"), ShouldBeNil)
		So(foo, ShouldResemble, apitoken.Token128{1, 5, 10, 50, 100, 255, 3, 13, 23, 56, 18, 99, 69, 8, 15, 9})
		So(foo.FromString("01050a3264ff030d1738126345080f0z"), ShouldNotBeNil)
	})
}